...
Tags: widget, recent posts, posts, plugin, sidebar, thumbnail, images, cache, tags, automatic, custom, Post, admin, image, previous posts, template function, template, page, administration, timthumb, English, French, Russian, Dutch
...
Base package includes .pot file for translation of the interface, and **English**, **French**, **Russian** and **Dutch** versions.
...
La distribution standard inclut le fichier de traduction .pot et les versions française, anglaise, russe et hollandaise.
