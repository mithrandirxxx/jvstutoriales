...
function yd_rp_plugin_reset( $force ) {
	...
	$default_thumbnail_img	= 'http://www.yann.com/yd-recent-posts-widget-v085-logo.gif';
...
function yd_rp_plugin_options() {
	...
	. '<img src="http://www.yann.com/yd-recent-posts-widget-v085-logo.gif" alt="YD logo" />'
	. '<br/><small>Enjoy this plugin?<br/>Help me improve it!</small><br/>'
	...
	. '</form>'
	. '<small><strong>Thanks - Yann.</strong></small>'
	. '</div>';
	if( isset( $_GET["do"] ) ) {
		...
		echo '<p>'
		. '<a href="http://www.yann.com/en/wp-plugins/yd-recent-posts-widget" target="_blank" title="Plugin FAQ">';
